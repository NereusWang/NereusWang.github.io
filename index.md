...
## **Personal Profile**
   + Wang Fang, master's student, studied in Shanghai Institute of Microsystems and Information Technology, Chinese Academy of Sciences, National Key Laboratory of Sensing, my research interests are human-computer interaction wearable intelligent devices, artificial intelligence bio-synergy algorithms, involving bio-tactile perception, computer vision perception, etc., skilled in machine learning, deep learning mainstream algorithms and frameworks, Raspberry Pi 4B, Nvidia Jetson Nano, etc. L participated in the research project of artificial intelligence chip and brain computer interface in University of Pennsylvania following Professor Jan Van Der Spiegel. During my master's degree, l won many competitions in the field of artificial intelligence held by the Ministry of Science and Technology of China, Chinese Academy of Sciences, Chinese Society of Artificial Intelligence, Chinese Institute of Electronics, Chinese Society of Communications etc. and won the first, second and third prizes in the country, the first prize in the China Engineering Robotics International Open Competition, the Bronze Award in the TCL Technology Group Youth Science and Technology Innovation Competition, and was invited to oral speak at the 2021 China Internet+ Youth Artificial Intelligence and Internet of Things Forum Oral and the self-designed intelligent medical robot based on graph neural network was selected into the high-quality project library of the future technological innovation competition of the Chinese Academy of Sciences.
